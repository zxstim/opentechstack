...
export default function BuidlGnosis(props) {
  ...
  return (
    <>
      ...
      <Head>
        <title>Gnosis Chain BUIDL resources | Tài liệu BUIDL trên Gnosis Chain - OpenTechStack.com</title>
        <meta charSet="utf-8" />
        ...
        <meta property="og:title" content="Gnosis Chain BUIDL resources | Tài liệu BUIDL trên Gnosis Chain - OpenTechStack.com" key="ogtitle" />
        ...
        <meta property="og:url" content="https://OpenTechStack.com/buidl/gnosis" key="ogurl" />
