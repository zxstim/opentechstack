...
export default function InfraPage({ entities, pagination }) {
  ...
  const headerContent = {
    title: "Discover Infrastructure projects - OpenTechStack.com",
    description: "Learn everything about Infrastructure projects, their team, investors, and what they do.",
  ...
  const paths = {
    fullPath: "/discover/infrastructure-projects",
    pathNamesEn: [
      "Discover",
      ...
      <div className="App">
        <div className="markdown-body">
          ...
          <GeneralList 
            ...
            indexPagePath="discover/infrastructure-projects"
            />
          <br />
          <hr />
          <AppFooter />
