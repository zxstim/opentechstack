  ...
  return (
    <>
      ...
      <AlertMessage 
        ...
        message="Read the full article about Ethereum [here](https://opentechstack.com/reading/what-is-klaytn)."
        markdown={true}
      />
      ...
      <Link 
        href="/build/klaytn/dev-roadmap"
        >
        Go to Roadmap ➡️
      </Link>
      <h2>Build on Klaytn</h2>
